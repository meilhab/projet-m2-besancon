...
L'annexe~\ref{chapterAnnexe:baseDeDonnees} permet d'avoir une description des diff\'erentes tables composant la base de donn\'ees, une vue g\'en\'erale de ce \`a quoi elle ressemble, et des vues d\'ecoup\'ees des diff\'erentes parties la composant.
...
\label{section:fonctionnalitesPubliques}

Ces fonctionnalit\'es sont accessibles par tous les utilisateurs appartenant \`a l'Universit\'e.
...
Ces fonctionnalit\'es sont un compl\'ement aux fonctionnalit\'es publiques du \S~\ref{section:fonctionnalitesPubliques}.
...
Le protocol Secure Sockets Layer, ou SSL, est con\c{c}u pour assurer la confidentialit\'e, l'authentification et l'int\'egrit\'es des donn\'ees lorsdes \'echanges entre un client et un serveur Web, sur diff\'erents protocoles de transport (en g\'en\'eral HTTP).
...
\section{G\'en\'eration de graphes d'utilisation}
...
correspondance entre tous les noms de salles dans timetables
...
\section{Migration des donn\'ees}
